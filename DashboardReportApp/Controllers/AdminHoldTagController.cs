...
namespace DashboardReportApp.Controllers
{
    ...
    public class AdminHoldTagController : Controller
    {
        ...
        public AdminHoldTagController(HoldTagService service)
        {
      ...
      //  {
      //      var parts = await _holdtagservice.GetPartsAsync();
       //     var operators = await _holdtagservice.GetOperatorsAsync();
      ...
      //  }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            List<HoldRecordModel> records = await _holdtagservice.GetAllHoldRecordsAsync();
